...
final class TexturesPatternsViewController: BaseViewController {
    ...
    let viewModel = TexturesPatternsViewModel()
...
extension TexturesPatternsViewController: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension TexturesPatternsViewController: UICollectionViewDataSourcePrefetching {
