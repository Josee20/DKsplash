//
//  TexturesPatternsViewModel.swift
//  DKsplash
//
...
final class TexturesPatternsViewModel: MainVMProtocol {
    
    public var mainModelList: MObservable<[MainModel]> = MObservable(value: [])
    internal var photoTitle: MObservable<String> = MObservable(value: "Textures&Patterns")
