...
final class FoodDrinkViewModel: MainVMProtocol {
    
    public var mainModelList: MObservable<[MainModel]> = MObservable(value: [])
    internal var photoTitle: MObservable<String> = MObservable(value: "Food&Drink")
    ...
    public func showPhotos() {
        APIManager.shared.requestSearchPhtosData(type: EndPoint.searchPhotos, title: photoTitle.value, page: currentPage.value) { json in
