...
final class FoodDrinkViewModel: MainVMProtocol {
    ...
    internal var photoTitle: Observable<String> = Observable(value: "Food&Drink")
    ...
    public func showPhotos() {
        APIManager.shared.requestPhtosData(type: EndPoint.searchPhotos, title: photoTitle.value, page: currentPage.value) { json in
